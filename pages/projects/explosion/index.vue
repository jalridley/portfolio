          ...
          <div class="mr-8 w-full">
            ...
            <p class="mb-5">
              ...
              <a
                ...
                class="text-blue-600 underline visited:text-purple-600 hover:text-blue-800"
                >Prodigy</a
              >, in the cloud, managing teams, annotators, data tasks, and
              running automated processes like model training (including LLMs),
              all while the user hosts their data on their own cluster. It was
              built in Vue/Nuxt 3 with Pinia, TailwindCSS, Typescript, Vitest,
              Cypress for e2e tests, Storybook for building components in
              isolation, Docker containers/Nomad. A far cry from beginner
              friendly for my first job in tech, but I thrived on the challenge.
            </p>

            <p class="mb-5">
              With permission from the founders (full disclosure: it was their
              idea), as a taste of a portion of my contributions, I am
              showcasing the dashboard feature and all of its components I made
              for Prodigy Teams. Instead of screenshots, have refactored it in
              its entirety for use in my portfolio to show the full code.
            </p>
